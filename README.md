...
- **Que.** Department of Computer Engineering has student's club named Pinnacle Club.
...
- **Que.** The ticket booking system of Cinemax theater has to be implemented using C++ program. 
...
## Assignment 10: Vaild Parenthesized   

- **Que.** In any language program mostly syntax error occurs due to unbalancing 
delimiter such as (),{},[]. Write C++ program using stack to check whether
given expression is well parenthesized or not.      
- **File :** `A10.cpp`

## Assignment 11: Simple Queue

- **Que.** Queues are frequently used in computer programming, and a typical example is the 
...
## Assignment 12: Double-ended Queue (deque)

- **Que.** A double-ended queue (deque) is a linear list in which additions and deletions may be made at either end. 
...
## Assignment 13: Circular Queue

- **Que.** Pizza parlor accepting maximum M orders. Orders are served in first come first served basis.
